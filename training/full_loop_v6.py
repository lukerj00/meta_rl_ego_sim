...
def single_step(EHT_t_1,eps):
    ...
    pos_t = jax.lax.cond((R_temp<(-ALPHA)),switch_agent,keep_agent,pos_t) # (x>=1)|(jnp.linalg.norm((dot-pos_t),ord=2)<=ALPHA)
