...
def new_params(params,e):
    ...
    params["SAMPLES"] = rnd.choice(ki[3],M,shape=(VMAPS,STEPS))
...
(loss_arr,loss_sem,v_pred_arr,v_t_arr,pos_arr,dot_arr,rel_vec_hat_arr,loss_v_arr,loss_d_arr,opt_state,p_weights) = forward_model_loop(SC,weights,params)
