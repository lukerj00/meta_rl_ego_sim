...
def forward_model_loop(SC,weights,params):
    ...
    return loss_arr,loss_std,p_weights_trained,v_pred,v_t,pos_t,dots,opt_state
...
(loss_arr,loss_std,p_weights_trained,v_pred_arr,v_t_arr,pos_arr,dots_arr,opt_state) = forward_model_loop(SC,weights,params)
...
plt.suptitle('forward_training_v9, '+title__,fontsize=14)
...
plt.savefig(path_ + 'forward_training_v9_' + dt + '.png')
...
plt.suptitle('forward_training_v9, '+title__,fontsize=10)
...
dt = datetime.now().strftime("%d_%m-%H%M%S")
plt.savefig(path_ + 'figs_forward_training_v9_' + dt + '.png')
...
save_pkl((loss_arr,loss_std,v_pred_arr,v_t_arr,pos_arr,dots_arr,opt_state,p_weights_trained),'forward_v9_'+str(M))