...
def new_params(params, e): # Modify in place
    ...
    params["HR_0"] = jnp.zeros((VMAPS,params["H_R"]))
...
def body_fnc(SC,hs_t_1,hr_t_1,hv_t_1,pos_t_1,dots,sel,ind,weights,weights_s,params): # PLAN_ITS
    ...
    return lp_arr,r_arr,sample_arr #,t_arr #
...
def full_loop(SC,weights,params):
    ...
    for e in range(E):
        ...
        if e == E-1:
            pass
    return loss_arr,sem_arr,plan_rate_arr,weights #r_arr,pos_arr,sample_arr,dots_arr
...
(loss_arr,sem_arr,plan_rate_arr,weights) = full_loop(SC,weights,params) # r_arr,pos_arr,sample_arr,dots_arr,v_loss_arr,r_loss_arr,r_true_arr
print(loss_arr)
