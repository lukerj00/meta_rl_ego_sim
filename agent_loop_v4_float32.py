# -*- coding: utf-8 -*-
"""
Created on Thu Dec  1 13:12:21 2022
...
def tot_reward(e0,h0,theta,psi):
    ...
    for t in range(it):
        eps = rnd.uniform(key_eps,shape=(it,2),dtype="float32")
...
def main():
    ...
    R_arr = jnp.arange(EPOCHS)
    
    # generate initial values
    ki = rnd.split(KEY_INIT,num=50)
    h0 = rnd.uniform(ki[0],(N,1),dtype="float32")
    W_f0 = rnd.uniform(ki[1],(N,N),dtype="float32")
    U_f0 = rnd.uniform(ki[2],(N,N),dtype="float32")
    b_f0 = rnd.uniform(ki[3],(N,1),dtype="float32")
    W_h0 = rnd.uniform(ki[4],(N,N),dtype="float32")
    U_h0 = rnd.uniform(ki[5],(N,N),dtype="float32")
    b_h0 = rnd.uniform(ki[6],(N,1),dtype="float32")
    C0 = rnd.uniform(ki[7],(2,N),dtype="float32")
