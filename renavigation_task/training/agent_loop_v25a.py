...
def single_step(EHT_t_1,eps):
    ...
    # reward from neurons
    (R_obj,sigma_e) = loss_obj_pos(e_t_1,sel,epoch,pos_t,SIGMA_R0,SIGMA_RINF,TAU,LAMBDA_N,LAMBDA_E,LAMBDA_D,LAMBDA_S) #obj(e_t_1,sel,SIGMA_R0,SIGMA_RINF,TAU,epoch)
    ...
    EHT_t = (e_t,h_t,theta,pos_t,sel,epoch,dot)###fixed
...
IT = 50 # 50
VMAPS = 500 # 500
UPDATE = jnp.float32(0.0005) # 0.0005
