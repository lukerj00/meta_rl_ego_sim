...
plt.suptitle('outer_loop_pg_new_v4fs, '+title__,fontsize=10)
...
dt = datetime.now().strftime("%d_%m-%H%M%S")
plt.savefig(path_+'outer_loop_pg_new_v4fs_'+dt+'.png')
...
save_pkl_sc((actor_opt_state,critic_opt_state,weights_s),'outer_loop_pg_new_v4fs') # no _
save_test_data(other,'outer_loop_pg_new_v4fs')