# -*- coding: utf-8 -*-
"""
Created on Sun Nov 27 14:54:29 2022
...
def new_env(e_t_1,h_t,v_t,theta):
    for i,(k,dot) in enumerate(e_t_1.items()):
        #print('dot_1 =',dot) #print(f'dot_1={dot:3.2f}')
        print('dot[0] = ',dot[0])
        print('dot[1] = ',dot[1])        
...
def main():
    ...
    for e in range(epochs): # or use jax.lax.scan(single_step,...)
        ...
        # R_tot, grads = jax.value_and_grad(tot_reward,argnums=2,allow_int=True)(e0,h0,theta,it,key_eps)
        # for grad in grads:
        #     print (type(grad))
            # for g in grad:
            #     print('grad = ',g)
        ...
        # print('R_tot =', R_tot) #print(R_arr, dot_loc)
        
        # just gradients
        G = jax.grad(tot_reward,argnums=2,allow_int=True)(e0, h0, theta, it, key_eps)
        print('grads = ',G)
