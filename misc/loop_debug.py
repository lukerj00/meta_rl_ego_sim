# -*- coding: utf-8 -*-
# move/plan timeseries, vanilla rnn
"""
...
#         v_t_ap = neuron_act_noise(samples[t-1],params["THETA_AP"],params["SIGMA_A"],params["SIGMA_N"],dot_arr[:,t],pos_plan_arr[:,t]) # pos_arr
#         v_t_full = neuron_act_noise(samples[t-1],params["THETA_FULL"],params["SIGMA_A"],params["SIGMA_N"],dot_arr[:,t],pos_plan_arr[:,t]) # pos_arr
...
#     v_pred_ap, v_pred_full, h_t = plan(h1vec_t, v_t_1_ap, h_t_1, pm_t, 'p_weights=global!', params["PLAN_ITS"])
...
# def body_fnc_new(SC, p_weights, params, key, pos_0, dot_0, dot_vec, h_0, samples, e):
#     pm_arr, pos_plan_arr, pos_arr, dot_arr, h1vec_arr, vec_arr = gen_timeseries(key, SC, pos_0, dot_0, dot_vec, samples, params["SWITCH_PROB"], params["TOT_STEPS"], params["MAX_PLAN_LENGTH"])
...
#     h_t, v_t_1_ap, tot_loss_v = final_carry
...
# new_params(params,0)
# loss, (v_pred_arr,v_t_arr,pos_plan_arr,pos_arr,dot_arr,pm_arr,loss_v_arr,loss_c_arr) = body_fnc(SC,weights["p_weights"],params,ke[0],params["POS_0"][0],params["DOT_0"][0],params["DOT_VEC"][0],params["HP_0"][0],params["SAMPLES"][0],0)
# print('loss: ',loss)
# print('v_pred_arr: ',v_pred_arr)

# old_policy_params = {'weights': jnp.array([1, 2, 3])}
# new_policy_params = old_policy_params

# new_policy_params['weights'] = new_policy_params['weights'] + 1

# print(old_policy_params['weights'])  # [1 2 3]
# print(new_policy_params['weights'])  # [2 3 4]

# params = {'weights': jnp.array([1, 2, 3])}
# print(id(params['weights']))  # Let's say this prints: 123456789

# params['weights'] = params['weights'] + 1
# print(id(params['weights']))  # This will print a different ID, say: 987654321

# params = {'weights': jnp.array([1, 2, 3])}
# print(params['weights'])   # prints: [1 2 3]
# initial_id = id(params['weights'])
# print(initial_id)  # Let's say this prints some memory address, e.g., 123456789

# params['weights'] = params['weights'] + 1
# print(params['weights'])   # prints: [2 3 4]
# updated_id = id(params['weights'])
# print(updated_id)  # This will print a different memory address

# print(initial_id == updated_id)  # This will print False
import copy

old_params = {'w': jnp.array([1, 2, 3])}
new_params = copy.deepcopy(old_params)

for i in range(5):
    new_params['w'] = new_params['w'] + 1
    print('new_params: ', new_params['w'])
    print('old_params: ', old_params['w'])
